...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2017. Ápr 20. 12:42
...
--
-- A tábla indexei `categories_series`
--
ALTER TABLE `categories_series`
  ADD KEY `categories_series_categoryid_foreign` (`categoryId`),
  ADD KEY `categories_series_seriesid_foreign` (`seriesId`);
...
ALTER TABLE `subscriptions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `subscriptions_transactionid_foreign` (`transaction_id`),
  ADD KEY `subscriptions_userid_foreign` (`user_id`);
...
ALTER TABLE `transactions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `transactions_paypalid_unique` (`paypal_id`),
  ADD KEY `transactions_userid_foreign` (`user_id`);
